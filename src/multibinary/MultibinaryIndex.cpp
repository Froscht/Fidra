...
#include <fidra/ida-compat/allins.hpp>
#include <fidra/ida-compat/auto.hpp>
#include <fidra/ida-compat/bytes.hpp>
#include <fidra/ida-compat/entry.hpp>
#include <fidra/ida-compat/funcs.hpp>
#include <fidra/ida-compat/hexrays.hpp>
#include <fidra/ida-compat/ida.hpp>
#include <fidra/ida-compat/idp.hpp>
#include <fidra/ida-compat/kernwin.hpp>
#include <fidra/ida-compat/lines.hpp>
#include <fidra/ida-compat/name.hpp>
#include <fidra/ida-compat/netnode.hpp>
#include <fidra/ida-compat/nalt.hpp>
#include <fidra/ida-compat/segment.hpp>
#include <fidra/ida-compat/ua.hpp>
#include <fidra/ida-compat/xref.hpp>

#include "VulnStub.h"
// vuln verification stub (see VulnStub.h)
